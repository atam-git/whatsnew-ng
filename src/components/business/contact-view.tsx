...
const FALLBACK = {
  email: 'hello@whatsnew.ng',
  twitterUrl: 'https://twitter.com/whatsnewng',
  instagramUrl: 'https://instagram.com/whatsnewng',
};

/** "https://twitter.com/whatsnewng" → "@whatsnewng" */
...
export function ContactView({ settings }: { settings: SiteSettings | null }) {
  ...
  // When settings loaded, honour null (hide the row); only fall back if the
  // whole settings object is missing.
  const twitterUrl = settings ? settings.twitterUrl : FALLBACK.twitterUrl;
  const instagramUrl = settings ? settings.instagramUrl : FALLBACK.instagramUrl;
    ...
    return (
      <div className="relative min-h-[60vh]">
        ...
        <div className="relative mx-auto max-w-2xl px-4 py-16 text-center sm:py-24">
          ...
          <h1 className="font-heading text-3xl font-bold text-gray-900 sm:text-4xl">Message Sent!</h1>
          <p className="mx-auto mt-4 max-w-xl text-lg text-gray-600">
            Thanks for reaching out. We&apos;ve received your message and will get back to you soon.
          </p>
          <p className="mt-6 text-sm text-gray-500">Typically within 1-2 business days</p>
              ...
              <div className="mt-6 space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${email}`} className="mt-1 text-sm text-red-600 hover:text-red-700">
                      {email}
                    </a>
                  </div>
                </div>
